...
public class EventManager {
    ...
    /*
        ...
        Value: HashMap
            ...
            Value: List
                0: Event Category
                1: OZEvent (Class that implements OZEvent)
    ...
    */
    ...
    public Object getEventData(String key, String interactionId) {
        HashMap<String,List<Object>> eventFromKey = events.get(key);

        if(eventFromKey == null) {
            return null;
        }

        if(eventFromKey.get(interactionId).size() < 2) {
            return null;
        }

        return eventFromKey.get(interactionId).get(2);
    }
